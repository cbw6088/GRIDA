...
export const wallpaperGuides: WallpaperGuide[] = [
  {
    ...
    points: [
      ...
      "광폭(약 930mm): 한 장 폭이 넓어 이음새가 적고 벽면이 한결 깔끔해 보임",
      "소폭(약 530mm): 이음새가 더 많아져 벽면 연속감은 다소 줄어들 수 있음",
      "광폭·소폭에 따라 자재 단가가 달라 총 비용 차이가 날 수 있음 (광폭이 일반적으로 더 비쌈)",
    ],
    note: "습기·오염에는 약한 편이라, 주방·욕실 인근보다는 건조한 생활 공간에 잘 맞습니다. 넓은 거실·긴 벽면은 광폭, 작은 방·비용 절감이 우선이면 소폭을 많이 검토합니다.",
    image: "/wallpapers/wallpaper-hapji.jpg",
  ...
  },
  {
    ...
    image: "/wallpapers/wallpaper-silk.jpg",
  ...
  },
  {
    ...
    image: "/wallpapers/wallpaper-hanji.jpg",
  ...
  },
  {
    ...
    image: "/wallpapers/wallpaper-mural.jpg",
